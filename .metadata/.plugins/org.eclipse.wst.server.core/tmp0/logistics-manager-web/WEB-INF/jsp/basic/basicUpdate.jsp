...
<body>
	<div class="place">
		...
		<ul class="placeul">
			<li><a href="/">首页</a></li>
			<li><a href="/basic/query">基础数据管理</a></li>
		</ul>
	</div>
	<div class="formbody">
		...
		<form action="/basic/saveOrUpdate">
			<ul class="forminfo">
				...
				<li><label>基础数据</label>
					...
					class="dfinput" value="${basic.baseName }"/>
					<i>基础数据不能超过30个字符</i>
				</li>
				<li><label>描述</label>
				...
				<li><label>所属类型</label>
					...
					<div class="vocation">
					    ...
					    <c:forEach items="${ parents}" var="parent">
					    	<option value="${parent.baseId }" ${parent.baseId eq basic.parentId?"selected":"" }>${parent.baseName }</option>
					    </c:forEach>
					    </select>
					</div>
					<i></i>
